          ...
          <div class="col-lg-6">
            ...
            <div class="songs-lists-wrap">
              ...
              <div class="songs-list">
                ...
                <div class="songs-name track-name flex-grow-1 col-auto"><a href="https://youtu.be/fWzimfoosMo" target="_blank"><?php
                        if($_SESSION['lan'] == 'EN')
                            echo 'Vineyard Highlight';
                        elseif ($_SESSION['lan'] == 'FR')
                            echo 'Points forts du vignoble';
                        elseif ($_SESSION['lan'] == 'CN')
                            echo '葡萄园亮点';
                        ?><br><span><?php
                            if($_SESSION['lan'] == 'EN')
              ...
              <div class="songs-list">
                ...
                <div class="songs-name track-name flex-grow-1 col-auto"><a href="https://youtu.be/9LdLbIfCYMw"> <?php
                        if($_SESSION['lan'] == 'EN')
                            echo 'vineyard video 1';
                        elseif ($_SESSION['lan'] == 'FR')
                            echo 'vineyard video 1';
                        elseif ($_SESSION['lan'] == 'CN')
                            echo '葡萄园视频1';
              ...
              <div class="songs-list">
                ...
                <div class="songs-name track-name flex-grow-1 col-auto"><a href="https://youtu.be/_S1KTSIpMLA"><?php
                        if($_SESSION['lan'] == 'EN')
                            echo 'vineyard video 2';
                        elseif ($_SESSION['lan'] == 'FR')
                            echo 'vineyard video 2';
                        elseif ($_SESSION['lan'] == 'CN')
                            echo '葡萄园视频2';
          ...
          <div class="col-lg-6">
            ...
            <div class="songs-lists-wrap">
              ...
              <div class="songs-list">
                ...
                <div class="songs-name track-name flex-grow-1 col-auto"><a href="https://youtu.be/aY_7dOuQbbc"><?php
                        if($_SESSION['lan'] == 'EN')
                            echo 'Interview Highlight video';
                        elseif ($_SESSION['lan'] == 'FR')
                            echo 'Vidéo des moments forts de l\'interview';
                        elseif ($_SESSION['lan'] == 'CN')
                            echo '采访精华视频';
                        ?><br><span> <?php
                            if($_SESSION['lan'] == 'EN')
              ...
              <div class="songs-list">
                ...
                <div class="songs-name track-name flex-grow-1 col-auto"><a href="https://youtu.be/7LOirb1N90g" target="_blank"><?php
                        if($_SESSION['lan'] == 'EN')
                            echo 'Interview Vedio 1';
                        elseif ($_SESSION['lan'] == 'FR')
                            echo 'Vidéo d\'entretien 1';
                        elseif ($_SESSION['lan'] == 'CN')
                            echo '采访视频1';
                        ?><br><span> <?php
                            if($_SESSION['lan'] == 'EN')
              ...
              <div class="songs-list">
                ...
                <div class="songs-name track-name flex-grow-1 col-auto"><a href="https://youtu.be/FsPuwaTKOn8" target="_blank"><?php
                        if($_SESSION['lan'] == 'EN')
                            echo 'Interview Vedio 2';
                        elseif ($_SESSION['lan'] == 'FR')
                            echo 'Vidéo d\'entretien 2';
                        elseif ($_SESSION['lan'] == 'CN')
                            echo '采访视频2';
                        ?><br><span><?php
                            if($_SESSION['lan'] == 'EN')
