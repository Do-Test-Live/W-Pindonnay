...
!function (e) {
    ...
    SEMICOLON.initialize = {
        ...
        init: function () {
            ...
            let i, n = e(".menu-item:has(.sub-menu-container)"), t = n.children(".menu-link"),
                s = ".mega-menu-content, .sub-menu-container", a = e(s), l = M.attr("data-trigger-speed") || 200;
            ...
            }, 1e3), M.find(a).css({display: ""})) : c.css({"margin-top": ""}), o.hasClass("overlay-menu") && M.hasClass("on-click") && (o.hasClass("device-xl") || o.hasClass("device-lg")) ? t.off("click").on("click", function (i) {
                let n = e(this);
        ...
        init: function () {
            ...
            e(window).on("pluginBootstrapReady", function () {
                e().tooltip ? e('[data-toggle="tooltip"]').tooltip({container: "body"}) : console.log("extras: Bootstrap Tooltip not defined."), e().popover ? e("[data-toggle=popover]").popover() : console.log("extras: Bootstrap Popover not defined.")
        ...
        init: function () {
            SEMICOLON.header.menufunctions(), SEMICOLON.header.fullWidthMenu(), SEMICOLON.header.stickyMenu(), SEMICOLON.initialize.dataResponsiveHeights(), SEMICOLON.initialize.stickFooterOnSmall(), SEMICOLON.slider.sliderDimensions(), SEMICOLON.slider.sliderParallax(), SEMICOLON.widget.html5Video(), SEMICOLON.widget.masonryThumbs(), SEMICOLON.initialize.dataResponsiveClasses(), SEMICOLON.customization.onResize(), E = l.width(), e(window).trigger("scwWindowResize")
        }
    ...
    let i, n, t, s, a, l = e(window), o = e("body"), r = e("#wrapper"), d = e("#header"), u = e("#header-wrap"),
        ...
        y = "", N = (u.outerHeight(), u.find(".header-row:eq(0)"), e("#content"), e("#footer")), E = l.width(),
